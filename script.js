...
var HTMLquestions = [
    ...
    {
        question: "تكتب أكواد لغة الجافا سكريبت داخل لغة",
        choices: ["PHP", "HTML", "C++", "Python"],
        answer: 2

    },

    {
        question: "تكتب جمل الجافاسكريبت داخل الأمر",
        choices: ["head", "section", "script", "span"],
        answer: 3

    },
    {
        question: "جملة تستخدم لعمل رسالة تحذيرية ",
        choices: ["alert", "function", "document.write", "console"],
        answer: 1

    },
    {
        question: "جملة تستخدم لإضافة نص علي صفحة الويب نفسها ة ",
        choices: ["alert", "document.write", "function", "span"],
        answer: 2

    },
    {/*5*/
        question: "مجموعة من الأوامر تنفذ عند استدعائها",
        choices: ["span", "function", "list", "ul"],
        answer: 2

    },
    {
        question: "لعمل تعبير شرطي نستخدم جملة",
        choices: ["function", "image", "pic", "if"],
        answer: 4

    },
    {
        question: "تعتبر أحد اللغات المستحدمة في اتطوير تطبيقات الويب",
        choices: ["Flutter", "C#", "JS", "Visual Basic"],
        answer: 3

    },
    {
        question: "عملية التحكم في البيانات التي يتم ادخالها",
        choices: ["النحقق من صحة البيانات", "مطابقة كلمات المرور ", "البحث", "المسح"],
        answer: 1

    },
    {
        question: "تحدد العملية التي سيتم تنفيذها عند الضغط علي submit",
        choices: ["function", "one.click", "method", "action"],
        answer: 4

    },
    {/*10*/
        question: "تعطي هذه الخاصية اسما للنموذج",
        choices: ["name", "input", "alert", "document.write"],
        answer: 1
